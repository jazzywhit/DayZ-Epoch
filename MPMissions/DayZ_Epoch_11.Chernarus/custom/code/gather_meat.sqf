...
_hasRazor = 	"ItemTrashRazor" in magazines player;
_type = typeOf _item;
_hasHarvested = _item getVariable["meatHarvested",false];
_config = 		configFile >> "CfgSurvival" >> "Meat" >> _type;

if ((_hasKnife || _hasKnifeBlunt || _hasRazor) && !_hasHarvested) then {
	//Get Animal Type
	...
	if (!_hasKnife && !_hasKnifeBlunt) then {
	    player removeMagazine "ItemTrashRazor";
	    cutText ["You destroyed your razor while gutting this animal", "PLAIN DOWN"];
	};
