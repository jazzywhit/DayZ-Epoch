if (!isDedicated) then {
	...
	call compile preprocessFileLineNumbers "custom\tow_lift\config.sqf";
	call compile preprocessFileLineNumbers format ["custom\tow_lift\lang\%1_lang.sqf", LOG_CFG_lANG];

	MONI_OBJECT	= compile preprocessFileLineNumbers "custom\tow_lift\monitor\monitor_object.sqf";
	MONI_ACTION	= compile preprocessFileLineNumbers "custom\tow_lift\monitor\monitor_action.sqf";
	LOG_OBJ_INIT = compile preprocessFileLineNumbers "custom\tow_lift\object\init.sqf";
	LOG_LIFT_INIT = compile preprocessFileLineNumbers "custom\tow_lift\lift\init.sqf";
	LOG_TOW_INIT = compile preprocessFileLineNumbers "custom\tow_lift\tow\init.sqf";
