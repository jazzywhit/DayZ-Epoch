...
_dayzActions =
[
	"s_player_cleanguts","DonorSkins","wardrobe","s_player_maintain_area","s_player_maintain_area_preview","BTC_SganciaActionId","BTC_liftActionId","BTC_liftHudId","dayz_myLiftVehicle","s_player_heli_detach",
	...
	"s_player_bury_human", "s_player_igniteVehicle", "s_player_igniteBuilding", "s_player_mining", "s_player_mine", "s_player_Safe_ckc"
];
/* ********************************************************************************* */
	//	NEW (EXPERIMENTAL):
